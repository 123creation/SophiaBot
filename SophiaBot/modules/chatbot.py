...
from SophiaBot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from SophiaBot import dispatcher, updater, SUPPORT_CHAT
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Sophia Chatbot disable by {}.".format(mention_html(user.id, user.first_name)),
...
ADD_CHAT_HANDLER = CallbackQueryHandler(hello, pattern=r"add_chat", run_async=True)
RM_CHAT_HANDLER = CallbackQueryHandler(hello, pattern=r"rm_chat", run_async=True)
